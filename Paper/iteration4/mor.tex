...
\label{thm:mor_cantelli}
    Assume \ref{ass:exog}--\ref{ass:moments}, $\mu_{ZX}>0$, and let $\delta \in (0,1), k = \lceil 8\ln{(1/\delta)} \rceil, m=\lfloor n/k\rfloor$. Write $\gamma_{\mathrm{MR}} = \sigma_{ZX}^2/(m\mu_{ZX}^2)$ and define
    \begin{equation}
    \label{eq:h_eta_mor}
