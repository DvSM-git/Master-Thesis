...
\textbf{This structure of this is a copy paste of section~\ref{sec:standard_iv}'s structure. A lot of statements will be repeated from earlier and thus are redundant. Nothing new is presented here that has not already been discussed in sections 2 or 3. This section applies what was done there to a different estimator. As such, it can be skipped}
